...
class Game:
	...
	def run(self):
		"""
		Vòng lặp game chính — chạy liên tục cho đến khi người dùng thoát.

		Mỗi iteration:
		1. Xử lý pygame events (QUIT, keyboard input).
		2. Cập nhật và vẽ màn hình tương ứng với self.state.
		3. Chuyển đổi giữa MENU, SETTINGS, LEADERBOARD và GAME.
		"""
